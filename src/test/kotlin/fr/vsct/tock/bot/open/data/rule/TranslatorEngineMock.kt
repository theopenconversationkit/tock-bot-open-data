        ...
        return when (target) {
            Locale.FRENCH ->
                when (text) {
                    ...
                    "station" -> "gare"
                    "Which station would you like to see the arrivals from?" -> "De quelle gare souhaitez vous voir les arrivées?"
                    ...
                    "Arrival {0}" -> "Arrivée {0}"
                    "What station do you want to see the departures from?" -> "De quelle gare souhaitez vous voir les départs?"
